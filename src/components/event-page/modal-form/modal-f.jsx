...
export default function ModalParticipate({ evento }) {
        ...
        <>
            ...
            <div className="py-6 px-8 flex justify-end">
                <button
                    ...
                    disabled
                    className="animate-bounce botao-efeito2 bg-green-500 hover:bg-green-700 text-xl fixed bottom-2 right-2 px-6 py-3 rounded-lg font-jaini shadow-md text-white"
                >
                    Em Desenvolvimento
                </button>
            </div>
