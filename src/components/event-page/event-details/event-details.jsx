...
import ModalMessage from "../../global/modal-messages/modal-m";
import CardInfoPayment from "../eventinfo-payment/card-i-p";
import CalendarEvent from "../calendar/calendar";
import EventAlert from "../event-alert/event-alert";
import PeriodEventBlock from "../event-period/event-period";
import BandsCard from "../bands/bands";
import Questions from "../event-questions/event-questions";
import ModalParticipate from "../modal-form/modal-f";
    ...
    <div className="min-h-screen md:px-2 px-2 py-2">
      <div className="mg-100">
              ...
              <ol className="relative border-l border-gray-200">
                ...
                <li className="mb-10 ms-6 ">
                  ...
                  <div className="flex flex-col justify-center">
                    ...
                    <PeriodEventBlock schedule={evento.schedule} />
                  </div>
                </li>
                    ...
                    {evento.bands?.length > 0 && (
                      <div className="grid grid-cols-1 gap-6">
                        {evento.bands.map((banda, index) => (
                          <BandsCard key={index} banda={banda} />
                        ))}
                      </div>
                    )}
                  </div>
        ...
        <div className="flex flex-col items-center justify-center p-8 rounded-lg w-full">
          ...
          <ModalParticipate evento={evento} />
      </div>
