...
import {  Users, Calendar, MapPin, Camera, Menu, X, Mails } from 'lucide-react';
...
const Navbar = () => {
    ...
    const menuItems = [
        { label: 'Sobre', icon: Users, href: 'Information' },
        { label: 'Eventos', icon: Calendar, href: 'Events' },
        { label: 'Equipe', icon: MapPin, href: 'Team' },
        { label: 'Recordações', icon: Camera, href: 'Souvenirs' },
        { label: 'Contato', icon: Mails, href: 'Contact' },
    ];
